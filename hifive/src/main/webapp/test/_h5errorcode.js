...
h5.u.obj.expose('ERRCODE.h5.core.controller', {
	...
	ERR_CODE_BIND_ROOT_ONLY: 6031,
	ERR_CODE_CONTROLLER_TOO_FEW_ARGS: 6032,
	ERR_CODE_CONTROLLER_INIT_REJECTED_BY_USER: 6033,
	ERR_CODE_BIND_NOT_NODE: 6034,
	ERR_CODE_METHOD_OF_NO_ROOTELEMENT_CONTROLLER: 6035,
	ERR_CODE_METHOD_OF_DISPOSED_CONTROLLER: 6036,
	ERR_CODE_CONSTRUCT_CANNOT_CALL_UNBIND: 6037,
	ERR_CODE_CONTROLLER_DISPOSE_REJECTED_BY_USER: 6038,
	ERR_CODE_CONTROLLER_MANAGE_CHILD_NOT_CONTROLLER: 6039,
	ERR_CODE_CONTROLLER_MANAGE_CHILD_UNBINDED_CONTROLLER: 6040,
	ERR_CODE_CONTROLLER_MANAGE_CHILD_BY_UNBINDED_CONTROLLER: 6041,
	ERR_CODE_CONTROLLER_MANAGE_CHILD_NOT_ROOT_CONTROLLER: 6042,
	ERR_CODE_CONTROLLER_UNMANAGE_CHILD_BY_UNBINDED_CONTROLLER: 6043,
	ERR_CODE_CONTROLLER_UNMANAGE_CHILD_NOT_CHILD_CONTROLLER: 6044,
	ERR_CODE_CONTROLLER_UNMANAGE_CHILD_NO_ROOT_ELEMENT: 6045,
	ERR_CODE_CONTROLLER_INVALID_INIT_DEFAULT_PARAM: 6046
});

h5.u.obj.expose('ERRCODE.h5.core.view', {
	ERR_CODE_TEMPLATE_COMPILE_NOT_STRING: 7000,
	ERR_CODE_TEMPLATE_FILE_NO_TEMPLATE: 7001,
	...
	ERR_CODE_TEMPLATE_COMPILE_SYNTAX_ERR: 7010,
	ERR_CODE_TEMPLATE_FILE_INVALID_ELEMENT: 7011,
	ERR_CODE_REQUIRE_DETAIL: 7100,
	ERR_CODE_UNKNOWN_BIND_DIRECTION: 7101,
	ERR_CODE_INVALID_CONTEXT_SRC: 7102
});
...
h5.u.obj.expose('ERRCODE.h5.core.data', {
	...
	ERR_CODE_INVALID_DESCRIPTOR: 15001,
	ERR_CODE_NO_ID: 15002,
	ERR_CODE_CANNOT_SET_ID: 15003,
	ERR_CODE_DESCRIPTOR_CIRCULAR_REF: 15004,
	ERR_CODE_CANNOT_CHANGE_REMOVED_ITEM: 15005,
	ERR_CODE_CANNOT_CHANGE_DROPPED_MODEL: 15006,
	ERR_CODE_INVALID_CREATE_ARGS: 15007,
	ERR_CODE_REQUIRE_SCHEMA: 15008,
	ERR_CODE_INVALID_SCHEMA: 15009,
	ERR_CODE_INVALID_COPYFROM_ARGUMENT: 15010,
	ERR_CODE_INVALID_ITEM_VALUE: 15011,
	ERR_CODE_DEPEND_PROPERTY: 15012,
	ERR_CODE_CANNOT_SET_NOT_DEFINED_PROPERTY: 15013,
	ERR_CODE_CANNOT_GET_NOT_DEFINED_PROPERTY: 15014,
...
h5.u.obj.expose('ERRCODE.h5.core.data_query', {
	...
	ERR_CODE_ALREADY_SET_ORDER_FUNCTION: 4,
	ERR_CODE_ALREADY_ADDED_ORDER: 5
});
...
h5.u.obj.expose('ERRCODE.h5.scene', {
	ERR_CODE_MAIN_CONTAINER_ALREADY_CREATED: 100003
});

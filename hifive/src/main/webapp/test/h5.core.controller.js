...
$(function() {
	...
	asyncTest('[browser#ie:6-9|chrome:0-25|firefox:0-17|safari:0-5|opera:0-12|windowsPhone:9]h5trackイベント(touchstart, touchmove, touchend) ※touchイベントをサポートしていないブラウザでは失敗します。', 26, function() {
	...
	asyncTest(
			'[browser#ie:6-9|chrome:0-25|firefox:0-17|safari:0-5|opera:0-12|windowsPhone:9]h5trackイベント(touchstart, touchmove, touchend) touchstart/move/end をtriggerした場合もh5trackイベントが発生するか ※touchイベントをサポートしていないブラウザでは失敗します。',
			27, function() {
				var controller = {
					__name: 'TestController',
					__ready: function() {
	...
	asyncTest(
			'[browser#ie:6-9|chrome:0-25|firefox:0-17|safari:0-5|opera:0-12|windowsPhone:9|android:0-2]h5trackイベント(touchstart, touchmove, touchend) SVG ※タッチのないブラウザ、SVG要素を動的に追加できないブラウザは失敗します。',
			26,
			function() {
				var controller = {
					__name: 'TestController',
	...
	asyncTest(
			'[browser#ie:6-9|chrome:0-25|firefox:0-17|safari:0-5|opera:0-12|windowsPhone:9]h5trackイベント(touchstart, touchmove, touchend) window ※タッチイベントのないブラウザでは失敗します',
			26,
			function() {
				var controller = {
					__name: 'TestController',

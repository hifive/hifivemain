...
(function() {
	...
	$.extend(Controller.prototype, {
		 ...
		 * <p>
		 * targetに<b>document</b>、<b>window</b>または<b>body</b>を指定すると、「スクリーンロック」として動作します。<br>
		 * 上記以外のDOM要素を指定した場合は、指定した要素上にインジケータを表示します。
		 * <p>
		 * <b>スクリーンロック</b>とは、コンテンツ領域(スクロールしないと見えない領域も全て含めた領域)全体にオーバーレイを、表示領域(画面に見えている領域)中央にメッセージが表示されるよう、インジケータを表示します。
		 * <h4>使用例</h4>
